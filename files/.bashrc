...
alias tree="eza -T -l --time-style 'relative' --no-user --total-size --git-ignore"
...
#FZF_COMPLETION_AUTO_COMMON_PREFIX=false
#zstyle ':completion::*:ls::*' fzf-completion-opts --preview='eval head {1}'
#source /home/matty/lib/fzf-tab-completion/bash/fzf-bash-completion.sh

source /home/matty/lib/fzf-obc/bin/fzf-obc.bash
#bind -x '"\t": fzf_bash_completion'

export THEMIS_HOME="$HOME/.vim/bundle/vim-themis" # Adjust path as necessary


# opencode
export PATH=/home/matty/.opencode/bin:$PATH
